...
class OOActuacionViewActuacion extends JViewLegacy
{
	function display($tpl=null)
	{
		...
		$document->addCustomTag('<script type="text/javascript" src="'.JURI::root(true).'/components/com_ooactuacion/views/actuacion/tmpl/js/entity.js" defer></script>');
